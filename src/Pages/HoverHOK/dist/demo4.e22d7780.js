...
},{"./1.jpg":"img/demo4/1.jpg","./10.jpg":"img/demo4/10.jpg","./11.jpg":"img/demo4/11.jpg","./13.jpg":"img/demo4/13.jpg","./12.jpg":"img/demo4/12.jpg","./15.jpg":"img/demo4/15.jpg","./14.jpg":"img/demo4/14.jpg","./16.jpg":"img/demo4/16.jpg","./17.jpg":"img/demo4/17.jpg","./18.jpg":"img/demo4/18.jpg","./2.jpg":"img/demo4/2.jpg","./19.jpg":"img/demo4/19.jpg","./20.jpg":"img/demo4/20.jpg","./3.jpg":"img/demo4/3.jpg","./4.jpg":"img/demo4/4.jpg","./5.jpg":"img/demo4/5.jpg","./7.jpg":"img/demo4/7.jpg","./6.jpg":"img/demo4/6.jpg","./8.jpg":"img/demo4/8.jpg","./9.jpg":"img/demo4/9.jpg"}],"js/demo4/menuItem.js":[function(require,module,exports) {
"use strict";
...
var images = Object.entries(require('../../img/demo4/*.jpg')); // track the mouse position
...
var MenuItem = /*#__PURE__*/function () {
  ...
  _createClass(MenuItem, [{
    ...
    value: function render() {
      ...
      this.animatableProperties.ty.current = Math.abs(mousepos.y - this.bounds.el.top) - this.bounds.reveal.height / 2; // new scale value

      this.animatableProperties.scale.current = this.firstRAFCycle ? 1 : (0, _utils.map)(mouseDistanceX, 0, 80, 1, 5); // new filter value

      this.animatableProperties.saturate.current = this.firstRAFCycle ? 1 : (0, _utils.map)(mouseDistanceX, 0, 10, 1, 0); // set up the interpolated values
      ...
      this.animatableProperties.saturate.previous = this.firstRAFCycle ? this.animatableProperties.saturate.current : (0, _utils.lerp)(this.animatableProperties.saturate.previous, this.animatableProperties.saturate.current, this.animatableProperties.saturate.amt); // set styles
